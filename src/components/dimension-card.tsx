  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        {dimension.rewrite_example && (
          <div className="mt-4 rounded-lg border border-[var(--primary)]/15 bg-[var(--primary)]/5 p-3">
            <p className="mb-1.5 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-[var(--primary)]">
              <svg
                width="12"
                height="12"
                viewBox="0 0 24 24"
        ...
        {dimension.issues.length === 0 && dimension.suggestions.length === 0 && !dimension.rewrite_example && (
